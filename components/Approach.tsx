  ...
  return (
    <section className="w-full py-4">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description="We work together to plan out the objectives, target audience, and essential features of your website. We talk about topics including content requirements, navigation, and site structure.">
        ...
        description="I start coding as soon as we decide on a strategy. I keep you informed at every stage, from rough designs to final code.">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        description="The magic happens right here! I'll translate everything into functional code based on the agreed design, starting from scratch to create your website.">
          <CanvasRevealEffect
            animationSpeed={3}
